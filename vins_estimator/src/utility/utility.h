...
//    ans.template block<3, 1>(0, 3) = qq.vec();
    ...
    static Eigen::Matrix<double, 3, 4> QuaternionGlobalDiff(const Eigen::Quaterniond& q, const Eigen::Vector3d& v)
    {
        ...
        JqpJq.leftCols(3) = tmp*Eigen::Matrix3d::Identity()+ qxyz*v.transpose() - v*qxyz.transpose() - q.w()*skewSymmetric(v);
    ...
    static Eigen::Matrix<double, 4, 4> QuaternionInv2Quaternion(const Eigen::Quaterniond& q)
    {
