...
template <typename Derived>
inline Eigen::Matrix<typename Derived::Scalar, 3, 4> Qleft_GlobalParameter(
    const Eigen::QuaternionBase<Derived>& q) {
  Eigen::Quaternion<typename Derived::Scalar> qq = positify(q);
  qq = qq.conjugate();
...
template <typename Derived>
inline Eigen::Matrix<typename Derived::Scalar, 4, 3> Qleft_LocalParameter(
    const Eigen::QuaternionBase<Derived>& q) {
  Eigen::Quaternion<typename Derived::Scalar> qq = positify(q);
...
inline Eigen::Matrix<double, 4, 4> QuaternionInv2Quaternion(
    const Eigen::Quaterniond& q) {
